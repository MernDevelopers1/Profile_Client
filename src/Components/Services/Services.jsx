                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 py-10 md:py-20">
                                {
                                    serviceData.map((service, index) => {
                                        return (
                                            <div key={index} className="bg-[#343330] shadow-lg rounded-xl py-10 flex flex-col items-center text-center transition-transform transform duration-300 ease-in-out hover:scale-105
