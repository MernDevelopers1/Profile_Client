      ...
      <div className="container mx-auto">
        <div className="py-6 md:py-16">
          <div className="flex justify-center relative">
            <h2
              className="text-5xl sm:text-7xl font-bold uppercase text-customblack text-center mb-12"
              data-aos="zoom-in"
          ...
          <p className="text-center mb-6 px-3 md:px-32 text-white text-2xl font-redhat">
            Located far beyond the horizons, bridging the East and the West
            reach out to elevate your business growth. Let’s connect and create
            opportunities together.
          </p>
          <div className="flex flex-col lg:flex-row">
            <div className="w-full md:w-9/12 mx-auto">
              <form onSubmit={onSubmit} className="px-3 lg:px-10">
                ...
                <div className="text-center">
                  ...
                  >
                    <p className="flex gap-3 items-center">
                      Send{" "}
                      <IoPaperPlaneSharp className="text-lightyellow text-2xl" />
                    </p>
                  </button>
                </div>
              </form>
