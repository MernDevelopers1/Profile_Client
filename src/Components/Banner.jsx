            ...
            <div className="relative py-56">
                ...
                <div className="relative container mx-auto">
                    <div className="flex flex-col justify-center items-center">
                        <h1 className="text-white text-[150px] font-bold leading-none mb-6 uppercase text-center stroke-text"
                            data-aos="zoom-in" data-aos-duration="2000">
                            Design Deliver Deploy
                        </h1>
                        <p className="text-white mb-6 text-2xl font-redhat text-center font-normal px-64"
